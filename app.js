...
function header(active="Home"){
 const chem=["Chemistry","Study Guide","Practice Tests","Challenge Lab","Open Ended","Mock Exam"].includes(active);
 ...
 '</nav><div class="navend"><button class="kbd" id="cmdBtn">⌘ K</button><button class="tool-btn" id="toolBtn">Tools</button><div class="avatar">LA</div></div></header>'
}
